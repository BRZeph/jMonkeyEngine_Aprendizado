...
import me.brzeph.domain.entity.enemies.behaviour.*;
import me.brzeph.domain.entity.enemies.behaviour.node.*;
...
public final class EnemiesConstants {
...
└── ActionNode (Fallback / Idle)
    └── post(MonsterIdleEvent)
        ...
        List<Player> playerList = List.of( // Deixando como lista para facilitar multiplayer.
                ((PlayerSystem) SystemAbs.getSystem(PlayerSystem.class)).getPlayer()
        );
        boolean debug = false;
